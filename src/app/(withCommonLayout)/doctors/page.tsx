...
import DashedLine from '@/components/Shared/UI/Doctor/DashedLine';
import DoctorCard from '@/components/Shared/UI/Doctor/DoctorCard';
import ScrollCategory from '@/components/Shared/UI/Doctor/ScrollCategory';
